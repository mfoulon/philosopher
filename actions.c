...
/**
 * The ft_single_philo function is used when there is only one
...
/**
 * The ft_multiple_philos function waits for the start of the game,
...
/**
 * The ft_print function prints the message.
 *
 * @param philo
 * @param msg
 */
...
/**
 * The ft_eat function locks the forks, eats and unlocks the forks.
 *
 * @param philo
 */
...
/**
 * The ft_sleep_and_think function sleeps and thinks.
 *
 * @param philo
 */
